export const mapLocations = {
    ...
    "Australia": {
        ...
        locations: [
            ...
            { name: "Canberra", mark: true, dashed: true, latLng: [-35.1594, 149.1183], photo: "/assets/pics/sabbatical/canbears.jpg", blurb: "At this point, I was honestly burnt out.</p><p class='popup-blurb'>I was applying to grad schools and while these dogs look adorable (Taylor on left, Oscar on right), Oscar would tear pillows up and gave me a nice bite on my arm while I was here.</p><p class='popup-blurb'>Canberra was...nice? It felt like an adult college campus with all the governmental buildings and green spaces. But the WORST part about Canberra were the bush flies. They don't bite but are attracted to sweat, so I'd take the dogs for a walk and you come back covered in 100 flies.</p><p class='popup-blurb'>Also saw loads of kangaroos. I was itching to throw hands with one but they didn't want any of this." },
