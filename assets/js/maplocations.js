export const mapLocations = {
    ...
    "Colombia": {
        ...
        locations: [
            ...
            { name: "Cartagena", mark: true, dashed: false, latLng: [10.4269, -75.5469], photo: "", blurb: "Before we arrived, there were incidents in the region involving tourists...robberies, assault, and worse. So while we had our fun, we kept things very tame (I got you mom). </p><p class='popup-blurb'>The locals were friendly - really good food (especially seafood & ceviche!) - and a full meal with drinks might cost you $15. A beer? Maybe $1.</p><p class='popup-blurb'>Look, we weren't complaining. And Aguila > Club Colombia."},
            { name: "Tierra Bomba", mark: true, dashed: false, latLng: [10.3254, -75.5907], photo: "", blurb: "Storytime. So we wanted to visit a beach - and quick research told us that the mainland beaches weren't good. Consensus was that you need to head to Tierra Bomba.</p><p class='popup-blurb'>So we took a rickity boat ferry across - all locals. Naturally we were charged twice the normal fare - a very authentic experience. When we got across, we were instructed to hop on motorcycles with some locals and they would take us to the beach bars...which luckily they did. But let's just say we could have very well ended up on the cover of the newspaper."},
            { name: "Cartagena", mark: false, dashed: false, latLng: [10.4269, -75.5469], photo: "", blurb: ""},
            { name: "Rosario Islands", mark: true, dashed: false, latLng: [10.1704, -75.7737], photo: "/assets/pics/sabbatical/phil_and_gude.jpg", blurb: "Took a catamaran out to the Rosario Islands to snorkel. Not a ton of wildlife unfortunately.</p><p class='popup-blurb'>So these islands are fairly remote and minimally developed - when you get near the island, guys in kayaks row out and they essentially have a full bar on the kayak with them. The hustle was impressive!"},
            ...
            { name: "Bogota", mark: true, dashed: true, latLng: [4.5966, -74.0701], photo: "", blurb: "Quick stopover for one night - it was quiet and there were a lot of abandon buildings. Bogota did not seem to be in the best shape."},
    ...
    "Croatia": {
        ...
        locations: [
            ...
            { name: "Kaprije", mark: true, dashed: false, latLng: [43.6884, 15.7090], photo: "/assets/pics/sabbatical/luka.jpg", blurb: "Favorite memory from Croatia.</p><p class='popup-blurb'>We rented an AirBnB from a guy named Marijan. Marijan was the man. So we chatted with him each day and he offered to take us on his boat with his wife (Kate) and son (Luka) - we happily accepted. We spent the afternoon on the boat and went to Kaprije for dinner, but the best part was getting to hang out with them.</p><p class='popup-blurb'>And look at Luka...made for the sea."},
            { name: "Jezera", mark: false, dashed: false, latLng: [43.7850, 15.6414], photo: "", blurb: ""},
    ...
    "Greece": {
        ...
        locations: [
            ...
            { name: "Ioannina", mark: true, dashed: false, latLng: [39.6690, 20.8576], photo: "", blurb: "Quaint city in the mountains of Greece on a lake. It has an interesting history with a lot of Turkish influence.</p><p class='popup-blurb'>I had tons of gelato and kataifi during the two days I was here between my big hikes."},
            { name: "Vikos Gorge", mark: true, dashed: false, latLng: [39.9162, 20.7478], photo: "/assets/pics/sabbatical/vikosgorge.jpg", blurb: "One of the most beautiful places I've ever been -- hiked to Drakolimni and Beloi Veiwpoint.</p><p class='popup-blurb'>This gorge reminded me of Zion National Park...except if Zion was more green with white rock. I would absolutely love to come back here and camp!"},
            ...
            { name: "Angelokastro", mark: true, dashed: false, latLng: [39.6786, 19.6886], photo: "/assets/pics/sabbatical/angelokastro.jpg", blurb: "Gorgeous."},
            { name: "Roda", mark: false, dashed: false, latLng: [39.7862, 19.7898], photo: "", blurb: ""},
            { name: "Kassiopi", mark: false, dashed: false, latLng: [39.7877, 19.9157], photo: "", blurb: ""},
            { name: "Albanian Overlook", mark: false, dashed: false, latLng: [39.7534, 19.9363], photo: "", blurb: ""},
            { name: "Pirgi", mark: false, dashed: false, latLng: [39.7102, 19.8523], photo: "", blurb: ""},
    ...
    "Australia": {
        ...
        locations: [
            ...
            { name: "Sydney", mark: true, dashed: true, latLng: [-33.8707, 151.2070], photo: "/assets/pics/sabbatical/kathleensydney.jpg", blurb: "Insane encounter in Sydney. So I was here for a day and a half and did the hike from Coogee to Bondi (highly recommend). On it, I ran into one of my old coworkers from FT Partners...in Sydney, Australia!</p><p class='popup-blurb'>And they say bankers don't get vacation...just kidding, she's in HR. Regardless, crazy encounter!</p><p class='popup-blurb'>The Sydney hostel was incredibly fun as well. Quite chaotic and the workers loved telling all the crazy stories they witnessed."},
            { name: "Tasmania", mark: true, dashed: true, latLng: [-42.8827, 147.3163], photo: "/assets/pics/sabbatical/dotty.jpg", blurb: "I loved Tasmania. This pet sit was perfect for me to hunker down and study.</p><p class='popup-blurb'>I was here for 37 days and was able to live comfortably frugal (averaged ~$20 a day). Dot was a gem; I absolutely miss this dog.</p><p class='popup-blurb'>Hobart is quaint and has really cool architecture (Victorian and Georgian, lots of brick). Tasmania is also known for the 'cleanest air on Earth' - and there were great hikes right outside the city. Learned to drive on the wrong side of the road and saw tons of paddy melons (mini kangaroos)!"},
