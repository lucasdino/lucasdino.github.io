(function () {
  const VERSIONS = [
    ...
    { id: "opus_47_cli_whimsy", label: "Claude Opus 4.7 (xHigh)", style: "whimsical", favorite: true, headline: "King Claudius", thoughts: "This is insane. So good. Totally took on the creative ask and delivered. Cannot believe this was a one-shot, so impressive (though it did mess up the map...can't be perfect :) ). Total API cost: $7." },
    // { id: "fable_5_whimsy", label: "Claude Fable 5 (High)", style: "whimsical", favorite: false, headline: "TBU", thoughts: "TBU" },
    { id: "gpt_6_astra", label: "GPT 6 Astra (xHigh)", style: "professional", favorite: false, headline: "Good but bland", thoughts: "Definitely a step up, some good ideas and ability to QA natively in Codex is super good. still cringe, OAI for the love of good please make your models not whack." },
    { id: "gpt_6_astra_whimsy", label: "GPT 6 Astra (xHigh)", style: "whimsical", favorite: false, headline: "Interesting", thoughts: "Honestly cool idea and fact that it whipped up a physics engine to make a pinball table is legit. Huge step up but still kind of bland taste. Also still cringe." },
    ...
    { id: "gpt_56_sol", label: "GPT 5.6 Sol (xHigh)", style: "professional", headline: "Basically GPT 5.5", thoughts: "I'm disappointed. It is a strong model but this is pretty mid. Not very impressed." },
    { id: "gpt_56_sol_whimsy", label: "GPT 5.6 Sol (xHigh)", style: "whimsical", headline: "Definitely whimsical", thoughts: "Formatting is a bit sloppy but this is...fun? yeah, I'd say it's fun. Also unique, doesn't feel like other AI vibe-coded sites I've seen / tested." },
    { id: "gpt_55_cli", label: "GPT 5.5 (xHigh)", style: "professional", headline: "OpenAI crushed with 5.5", thoughts: "Very similar thoughts on 5.4 (strong agentic ability, actually undertook a full redesign, result is super clean). Still a lot of cringe-writing. But it really took on the ask, used tons of tool calls to QA (w/ Playwright). Best agentic ability IMO.", archived: true },
    { id: "gpt_55_cli_whimsy", label: "GPT 5.5 (xHigh)", style: "whimsical", headline: "Quite decent", thoughts: "It's kind of fun...I like triangulation effect. It is very similar to GPT 5.4 -- clearly a similar model (not spud...) but much more polished. Website has some spunk to it. Overall decent, nothing to hate but doesn't blow me away.", archived: true },
    ...
    { id: "gemini_35_flash", label: "Gemini 3.5 Flash", style: "professional", favorite: false, headline: "Google Making Progress", thoughts: "This is actually quite a nice professional design but has some cringe writing. Feels very GPT in that way. Looks very solid and has a few tasteful touches (like the dino game)."},
    { id: "gemini_35_flash_whimsy", label: "Gemini 3.5 Flash", style: "whimsical", favorite: false, headline: "Not Great", thoughts: "It isn't horrible but leaves a lot to be desired. Underwhelming."},
    { id: "gemini_31_cli", label: "Gemini 3.1 (Pro)", style: "professional", headline: "Great designer, underwhelming agent", thoughts: "Fun and unique design. Issue is that I asked it to not just redesign but restructure the whole website -- which it didn't do. So as a designer? Excellent. As an instruction-following agent? May want to work on that.", archived: true },
    { id: "gemini_31_cli_whimsy", label: "Gemini 3.1 (Pro)", style: "whimsical", headline: "Kinda fun 🦖", thoughts: "It's fun but not that interesting. Just restyled of my old website, didn't think for that long. I like the vibe, but a bit underwhelming.", archived: true },
  ];
